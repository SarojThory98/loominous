...
export class Order_OrderItemValidation {
    public orderValidation = async ({body}: JoiLoginInterface): Promise<JoiResponseInterface> => {
    ...
    public skuOrderStatusUpdateValidation = async ({body}: JoiLoginInterface): Promise<JoiResponseInterface> => {
...
export default Order_OrderItemValidation
